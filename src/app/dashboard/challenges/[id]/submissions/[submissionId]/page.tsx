  ...
  return (
    <div className="max-w-xl mx-auto mt-10">
      <h1 className="text-2xl font-bold mb-6">
        Submission by {sub.username ? sub.username : "Unknown"}
      </h1>
      <div className="mb-4">
        <span className="font-medium">Evidence:</span> {sub.evidence}
      </div>
      ...
      <Link
        href={`/dashboard/challenges/${params.id}/submissions`}
        className="inline-block px-6 py-2 bg-primary text-white rounded-lg font-semibold shadow hover:bg-primary/90 transition"
      >
        Back to Submissions
      </Link>
    </div>
